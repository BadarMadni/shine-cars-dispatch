  ...
  try {
    ...
    const driver = await prisma.driver.findUnique({
      ...
      include: {
        documents: true,
        bookings: {
          select: { id: true, pickup: true, dropoff: true, pickupDetails: true, dropoffDetails: true, buildingInfo: true, date: true, time: true, status: true, fare: true, vehicle: true, isRecurring: true },
