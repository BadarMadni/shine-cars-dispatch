  ...
  try {
    ...
    return NextResponse.json({
      ...
      driver: {
        ...
        vehicleMake: driver.vehicleMake, vehicleColor: driver.vehicleColor, vehicleReg: driver.vehicleReg, passengerLicense: driver.passengerLicense, commissionRate: driver.commissionRate,
